...
namespace QLDiemSVKhoaCNNT.DBConnection
{
    ...
    {
        public const string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=QLDiemSVKhoaCNTT;Integrated Security=True;TrustServerCertificate=True";
