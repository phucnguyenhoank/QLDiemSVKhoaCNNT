...
namespace QLDiemSVKhoaCNNT
{
    public partial class FrmQLGiangVien : Form
    {
        ...
        private void btnGiangVienDayNhieuDKNhat_Click(object sender, EventArgs e)
        {
            try
            {
                FrmGiangVienDayLopNhieuDKNhat frmGiangVienDayLopNhieuDKNhat = new FrmGiangVienDayLopNhieuDKNhat();
                frmGiangVienDayLopNhieuDKNhat.ShowDialog();
            }
            catch (SqlException sqlEx)
            {
                // Bắt lỗi từ SQL Server nếu có
